            ...
            html: `
                <div style="text-align: left; margin: 1rem 0;">
                    <div style="background: #f8f9fa; padding: 1rem; border-radius: 8px; margin-bottom: 1rem;">
                        <h4 style="margin-bottom: 0.5rem; color: #333;">📋 Exam Details:</h4>
                    ...
                    <div style="background: #e3f2fd; padding: 1rem; border-radius: 8px;">
                        <h4 style="margin-bottom: 0.5rem; color: #1976d2;">📌 Instructions:</h4>
                                        ...
                                        <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                                            ${result.options.map((option, optionIndex) => {
                                                ...
                                                ">
                                                    ...
                                                    <span>${option}</span>
                                                    ${isCorrectAnswer ? '<span style="margin-left: auto; font-size: 0.8rem; font-weight: bold; color: #28a745;">(CORRECT)</span>' : ''}
                                                    ${isUserChoice && !isCorrectAnswer ? '<span style="margin-left: auto; font-size: 0.8rem; font-weight: bold; color: #dc3545;">(YOUR CHOICE)</span>' : ''}
                                                </div>`;
                                            }).join('')}
                                        </div>
                                    </div>
